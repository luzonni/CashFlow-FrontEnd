...
export default function CardInvoice() {
    return (
        <div className="w-123 flex flex-col rounded-xl shadow-2xl bg-surface">
            <div className="w-full flex flex-row justify-between bg-foreground items-center p-4 rounded-t-2xl">
    ...
    return (
        <>
            ...
            <div className="flex flex-row justify-between items-center py-2">
                ...
                <div>
                    <h1 className={`${positive ? "text-success" : "text-danger"} text-xl`}>{positive ? "+" : "-"} {value}</h1>
                </div>
            </div>
        </>
    )
